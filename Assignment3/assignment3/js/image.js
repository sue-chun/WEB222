...
window.onload = function() {
    ...
    image.innerHTML = "<a href=\"https://ict.senecacollege.ca/\"><img src='img/ict.png' alt='ICT School, Seneca College'>";
    
    var naturephoto = document.querySelector("#naturephoto");
    var sentence = "";
    for (var i = 0; i < images.length; i++) {
        sentence += "<figure><img src=\"" + images[i].url + "\" alt=\"" + images[i].alt + "\"" + "/><figcaption>" + images[i].caption + "</figcaption></figure>" 
    }
    naturephoto.innerHTML = sentence;
