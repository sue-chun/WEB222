...
window.onload = function () {
    ...
    var sentence = "<table style=\"border:1px solid;\">" + "<tr><th>First Name</th> <th>Last Name</th> <th>Age</th> <th>Email</th>"
    
    for (var i = 0; i < users.length; i++) {
        sentence += "<tr><td>" + users[i].first_name + "</td><td>" + users[i].last_name + "</td><td>" + users[i].age + "</td><td>" + "<a href= \"mailto:" + users[i].email + "\">" + users[i].email + "</a></td></tr>"
    }
    sentence += "</table>"
    contact.innerHTML += sentence;
};